...
import type { FeatureVector } from '../../analysis/features/FeatureExtractor.ts';
import { extractFeatures } from '../../analysis/features/FeatureExtractor.ts';
import type { GeometryDescriptor } from '../../analysis/geometry/GeometryDescriptor.ts';
...
import { proposeGrid } from '../../analysis/strategy/proposeGrid.ts';
import { filterByWindow, latestDrawDate } from '../../analysis/scoring/TemporalWindow.ts';
import type { TemporalWindow } from '../../analysis/scoring/TemporalWindow.ts';
import type { BaselineComparison } from '../../analysis/backtest/compareBaselines.ts';
import { compareBaselines } from '../../analysis/backtest/compareBaselines.ts';
import type { OverfittingSignal } from '../../analysis/backtest/detectOverfitting.ts';
import { detectOverfitting } from '../../analysis/backtest/detectOverfitting.ts';
import type { MonteCarloResult } from '../../analysis/backtest/runMonteCarloComparison.ts';
import { runMonteCarloComparison } from '../../analysis/backtest/runMonteCarloComparison.ts';
import type { BacktestMetrics, DateRange } from '../../analysis/backtest/runWalkForwardBacktest.ts';
import { runWalkForwardBacktest } from '../../analysis/backtest/runWalkForwardBacktest.ts';
import type { TrainValidationTestRanges } from '../../analysis/backtest/splitDateRanges.ts';
import { splitDateRanges } from '../../analysis/backtest/splitDateRanges.ts';
